...
\label{sec:TEE}
Authentication of a specific IoT device assumes that this device is the only
...
%
A state-of-the-art approach is to use a TEE,
...
even when having access to Trust Zoneor SGX.
%
