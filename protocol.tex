...
\label{sec:TEE}
Adversaries may have physical access to implementations, this is perhaps an
even higher risk in an unsupervised IoT setting.
%
Implementations can make use of Trusted Execution Environments (TEE) hardened
against physical attacks to mitigate adversaries with physical access to the
cryptographic keys.
%
