...
\paragraph{Amplification and asymmetry.}
...
%
In addition to the computational resources the responder spends, communication
patterns in the underlying protocols may require the responder to
...
good general information about DoS for protocols with this structure.
%
