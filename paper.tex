...
In addition to these default operations, \mEdhoc{} is built over the following
functions: \mHkdfExpand, \mHkdfExtract, and \mAead{}.
%
...
\mXor-ing a single term on the entire tuple for these cases. \\
%
