...
\vnote{Can we add extra references here? SAPIC+ etc?} As in~\cite{Norr21}, we verify \mEdhoc{} in the Dolev-Yao model~\cite{DY83}.
%
...
For syntactic sugar, \mTamarin{} allows the use of let-bindings and tuples. 
%
